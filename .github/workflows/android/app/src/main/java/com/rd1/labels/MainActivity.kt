        ...
        <body>
          <div class="app">
            <div class="card">
              ...
              <div class="muted">Мобильный Android wrapper для конструктора щита и маркировки</div>
              <div class="tabs">
                <div class="tab active">Конструктор</div>
                <div class="tab">Наклейки</div>
                <div class="tab">Схема</div>
            ...
            <div class="card">
              <div class="label">Последние проекты</div>
